...
public class LayoutActivityIII extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_iii);

        mOnClickEvent = new onClickEvent();
        mBtnNext = findViewById(R.id.btn_iii_next);
        mBtnPrev = findViewById(R.id.btn_iii_prev);
    ...
    private class onClickEvent implements View.OnClickListener{
        ...
        public void onClick(View view) {
            if(view.getId() == R.id.btn_iii_next){
                Toast t = Toast.makeText(getApplicationContext(), "Próxima tela!", Toast.LENGTH_SHORT);
                t.show();
                Intent intent = new Intent(getApplicationContext(), LayoutActivityIV.class);
                intent.putExtra("MSG", "42!?");
                startActivity(intent);
                return;

            }//if(view.getId() == R.id.btn_main_next){

            if(view.getId() == R.id.btn_iii_prev){
